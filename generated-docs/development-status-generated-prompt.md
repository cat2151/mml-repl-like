...
## 現在のオープンIssues
## [Issue #9](../issue-notes/9.md): FlMML on HTML5 にも変換してみたい
- mml-template-generator への追加を検討する

- 参考資料
  - FlMML on HTML5 http://argentum384.github.io/flmml-on-html5/
  - FlMML on HTML5 の SiON wrapperの検討  https://github.com/minipop/flmml-vs-sion...
ラベル: 
...
## [Issue #8](../issue-notes/8.md): GM128音色で編集したい
- Sionic.js Fork版に実装する方向で検討する...
ラベル: 
...
## [Issue #5](../issue-notes/5.md): iPadで音が途切れる
